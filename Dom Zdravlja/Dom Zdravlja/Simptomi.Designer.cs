...
namespace Dom_Zdravlja
{
	partial class Simptomi
	{
		...
		private System.Windows.Forms.Button button_Posalji;
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Simptomi));
			...
			this.button_Posalji = new System.Windows.Forms.Button();
			...
			this.checkBox5.Text = "Glavobolja";
			...
			this.checkBox6.Text = "Vrtoglavica";
			...
			this.button_Posalji.Text = "Pošalji";
			this.button_Posalji.UseVisualStyleBackColor = true;
			this.button_Posalji.Click += new System.EventHandler(this.Posalji);
			// 
			// checkBox8
			// 
			...
			this.checkBox8.Text = "Bol u grlu";
			...
			this.checkBox9.Text = "Malaksalost";
			...
			this.checkBox12.Location = new System.Drawing.Point(668, 146);
			this.checkBox12.Name = "checkBox12";
			this.checkBox12.Size = new System.Drawing.Size(129, 37);
			this.checkBox12.TabIndex = 12;
			this.checkBox12.Text = "Alergija";
			...
			this.checkBox16.Text = "Bol u stomaku";
			...
			this.checkBox18.Text = "Upala sinusa";
			...
			this.checkBox11.Text = "Upala uha";
			...
			this.checkBox10.Location = new System.Drawing.Point(387, 145);
			this.checkBox10.Name = "checkBox10";
			this.checkBox10.Size = new System.Drawing.Size(152, 37);
			this.checkBox10.TabIndex = 10;
			this.checkBox10.Text = "Upala krajnika";
			...
			// dataSql2
			// 
			this.dataSql2.AllowUserToAddRows = false;
			...
			this.Controls.Add(this.button_Posalji);
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.SimptomiFormClosing);
			((System.ComponentModel.ISupportInitialize)(this.dataSql)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.dataSql2)).EndInit();
